# -*- coding: utf-8 -*-
"""
Created on Fri Apr 12 19:26:13 2024
...
f=open("C:\\Users\\Admin\\Desktop\\Subjects\\BUS 602 Strategy for Business Analytics\\Presnetation\\data transformations\\Features_Selected_Deci_tree_balanced_unflagged.txt","r")
...
X_train, X_test, y_train, y_test=train_test_split(X, y, test_size=0.48,shuffle=True,random_state=42,stratify=y)
...
graph.render("C:\\Users\\Admin\\Desktop\\Subjects\\BUS 602 Strategy for Business Analytics\\Presnetation\\data transformations\\Decision Tree Balanced Unflagged Dataset")
